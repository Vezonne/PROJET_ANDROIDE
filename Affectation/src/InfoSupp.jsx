...
const InfoSupp = () => {
  ...
  const handleInputChange = (index, name, value) => {
    ...
    if (scoresLocalStorage) {
      console.log("scoresLocalStorage :", scoresLocalStorage);
  ...
  const handleSubmit = (e) => {
    ...
    console.log("allScoresPresent :", allScoresPresent);
    ...
    console.log("updatedProjetsSelectionnes :", updatedProjetsSelectionnes);
  ...
  return (
    <div>
      <h1>Informations sur le Projet {projectId}</h1>
